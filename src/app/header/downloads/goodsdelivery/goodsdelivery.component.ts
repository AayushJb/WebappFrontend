...
@Component({
  selector: 'app-goodsdelivery',
  templateUrl: './goodsdelivery.component.html',
  styleUrls: ['./goodsdelivery.component.css']
})
export class GoodsdeliveryComponent implements OnInit {

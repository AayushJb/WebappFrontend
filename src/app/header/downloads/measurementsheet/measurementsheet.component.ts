...
@Component({
  selector: 'app-measurementsheet',
  templateUrl: './measurementsheet.component.html',
  styleUrls: ['./measurementsheet.component.css']
})
export class MeasurementsheetComponent implements OnInit {
  ...
  constructor(public wqgformService : WqgformService,public sitedetailsservice : SitedetailsService, public procoreService : ProcoreService, public route : ActivatedRoute) { }

...
@Component({
  selector: 'app-glassledgerdetails',
  templateUrl: './glassledgerdetails.component.html',
  styleUrls: ['./glassledgerdetails.component.css']
})
export class GlassledgerdetailsComponent implements OnInit,OnDestroy {
  ...
  constructor(public dialogRef : MatDialogRef<GlassledgerdetailsComponent>,
  ...
  ngOnInit(): void {
   ...
   // this.ledgerdetailsService.getCurrentDateTime();
    ...
    this.OrderNumber = this.glassledgerdetailsService.OrderNumber;
    this.ProjectName = this.glassledgerdetailsService.ProjectName;
  ...
  const ledgerdetail : LedgerDetail = {
    ...
    this.glassledgerdetailsService.addLedgerDetails(ledgerdetail);

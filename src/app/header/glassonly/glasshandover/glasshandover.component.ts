...
@Component({
  selector: 'app-glasshandover',
  templateUrl: './glasshandover.component.html',
  styleUrls: ['./glasshandover.component.css']
})
export class GlasshandoverComponent implements OnInit, OnDestroy{
  form : FormGroup;
  OrderNumber : string;
  ProjectName : string;
  ...
  constructor(public dialogRef : MatDialogRef<GlasshandoverComponent>,
  ...
  ngOnInit(): void {
    ...
    this.ProjectName = this.glasshandoverService.ProjectName;
    this.OrderNumber = this.glasshandoverService.OrderNumber;
    this.FinalAmount = this.glasshandoverService.FinalAmount;
    this.OrderId = this.glasshandoverService.OrderId;
   ...
   this.glasshandoverService.getSpecialRequests().subscribe((specialresponse)=>{
    ...
    this.csdataSub = this.getjbservice.getCSDataUpdateListener().subscribe((CSDat)=>{
     ...
     this.SpecialRequest = specialresponse.specialrequests
      ...
      if(this.AdvanceReceived!==0)
      {
       ...
       let Billed = CSData.DISPATCHPIVALUE
  ...
  onSaveHandOverDetails()
  {
    ...
    this.glasshandoverService.addHandoverDetails(HandoverDetails);
    this.OnCloseDialog();
